const getLectureURL = (day, hour) =>
  `${document.URL}-1.IBehaviorListener.0-timetablePanel-content-timetableAxisListView-${hour}-timetableBeanListList-${day}-course-0-lectureLink`;
